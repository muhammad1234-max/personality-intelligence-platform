...
async def lifespan(app: FastAPI):
    ...
    # Fast startup: Ontology will be loaded lazily on the first request to prevent CPU starvation.
...
# CORS middleware
# Use ALLOWED_ORIGINS env var, default to localhost for development
